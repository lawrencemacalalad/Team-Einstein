...
git clone https://github.com/lawrencemacalalad/TeamEinstein.git && cd ./TeamEinstein &&py LawrenceM.py >> Einstein.csv &&py Adetutu.py >> Einstein.csv &&py Kacimi_Drug_Develpment.py >> Einstein.csv &&py Menna.py >> Einstein.csv &&py Ihechi.html.py >> Einstein.csv &&js Yakumbur.js >> Einstein.csv &&py Internship.py >> Einstein.csv &&php Deborah.php >> Einstein.csv &&py feyisayo.py >> Einstein.csv &&js olalekan.js >> Einstein.csv &&py ekene_ezeunala_@David.py >> Einstein.csv
